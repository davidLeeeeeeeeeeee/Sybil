...
contract_cols = ['action_1','action_4','action_7','last_contract_2' ]
...
# 输出到新的CSV文件
final_df.to_csv('filter_20group147.csv', index=False)
...
# 输出到新的CSV文件
final_df.to_csv('filter_20group135.csv', index=False)